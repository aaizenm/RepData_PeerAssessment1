...
```
```{r echo=FALSE}
qplot(x=weekday.interval$interval, y=weekday.interval$steps, data=weekday.interval, geom='line')+ geom_line(colour="red", stat="identity")+ labs(title='Average Number of Steps Taken Averaged Across Weekday Days\n',y='Averaged across weekday days', x='Total intervals in 24 Hours')
